    ...
    if fund_id:
        buttons.extend(
            [
                [
                    InlineKeyboardButton(
                        text="➕ Добавить взнос",
                        callback_data=f"add_donation:{fund_id}",
                    )
                ],
                [
                    InlineKeyboardButton(
        ...
        buttons.extend(
            [
                ...
                [
                    InlineKeyboardButton(
                        text="📊 Статистика", callback_data="treasurer_stats"
                    )
                ],
            ]
        )
...
def get_admin_keyboard() -> InlineKeyboardMarkup:
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(
                text="🎂 Создать сбор на ДР", callback_data="create_birthday_fund"
            ),
            InlineKeyboardButton(
                text="🎉 Создать сбор на событие", callback_data="create_event_fund"
            ),
        ],
        [
            InlineKeyboardButton(
                text="💰 Назначить казначея", callback_data="assign_treasurer"
            )
        ],
        [
...
def get_superadmin_keyboard() -> InlineKeyboardMarkup:
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="👑 Назначить админа", callback_data="promote_admin"
            ),
            InlineKeyboardButton(text="👎 Снять админа", callback_data="demote_admin"),
        ],
        [
            InlineKeyboardButton(
                text="❌ Удалить пользователя", callback_data="remove_user"
            )
        ],
        [
            InlineKeyboardButton(
...
def get_confirmation_keyboard(action: str, item_id: int) -> InlineKeyboardMarkup:
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="✅ Да", callback_data=f"confirm_{action}:{item_id}"
            ),
            InlineKeyboardButton(
                text="❌ Нет", callback_data=f"cancel_{action}:{item_id}"
            ),
        ]
    ]
    return InlineKeyboardMarkup(inline_keyboard=buttons)
...
def get_notification_keyboard(notification_id: int) -> InlineKeyboardMarkup:
    ...
    buttons = [
        [
            InlineKeyboardButton(
                text="✅ Прочитано",
                callback_data=f"read_notification:{notification_id}",
            ),
            InlineKeyboardButton(
                text="🔔 Напомнить позже",
                callback_data=f"remind_later:{notification_id}",
            ),
        ]
    ]
    return InlineKeyboardMarkup(inline_keyboard=buttons)
...
def get_broadcast_type_keyboard() -> InlineKeyboardMarkup:
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton(
                text="🎂 Кроме именинников", callback_data="broadcast_no_birthday"
            ),
        ],
        [
            InlineKeyboardButton(
                text="🏢 По отделу", callback_data="broadcast_department"
            )
        ],
    ]
    return InlineKeyboardMarkup(inline_keyboard=buttons)
