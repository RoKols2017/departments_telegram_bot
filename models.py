...
class User(Base):
    ...
    managed_funds = relationship(
        "Fund", back_populates="treasurer", foreign_keys="Fund.treasurer_id"
    )
    birthday_funds = relationship(
        "Fund", back_populates="birthday_person", foreign_keys="Fund.birthday_person_id"
    )
...
class Fund(Base):
    ...
    # Отношения
    treasurer = relationship(
        "User", back_populates="managed_funds", foreign_keys=[treasurer_id]
    )
    birthday_person = relationship(
        "User", back_populates="birthday_funds", foreign_keys=[birthday_person_id]
    )
